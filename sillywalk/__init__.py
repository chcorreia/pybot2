...
class Mundo():
    ...
    def __init__(self, largura=8, altura=8, ladrilho=64, espera=False, explodir=True):
    ...
    def mostra_msg(self, x, y, mensagem):
        # prepara a mensagem
        font_name = os.path.join(SW_DATA_DIR, 'DejaVuSans-Bold.ttf')
...
class Moedas(Objeto):
    def __init__(self, x, y, valor=None):
        ...
        font_name = os.path.join(SW_DATA_DIR, 'DejaVuSansMono-Bold.ttf')
